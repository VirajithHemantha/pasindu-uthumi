...
import { Sparkles, MapPin, Calendar, Clock, Volume2, VolumeX, Heart } from "lucide-react";

/**
 * Premium Sri Lankan Wedding Invitation Theme
 * Names: Denuwan and Subodha
...
const INVITE = {
  couple: {
    first: "පසිඳු",
    second: "උතුමි",
    display: "පසිඳු සහ උතුමි",
    displayUpper: "පසිඳු සහ උතුමි",
    monogram: "P U",
  },
  hero: {
    saveTheDateMonth: "සැප්තැම්බර් 13, 2026",
    dateLabel: "13 සැප්තැම්බර් 2026",
    locationLabel: "අලුබෝමුල්ල",
  },
  details: {
    dayMonthLabel: "සැප්තැම්බර් මස 13 වෙනි ඉරුදින",
    yearLabel: "2026",
    startTimeLabel: "පෙරවරු 11ට",
    endTimeLabel: "",
    poruwaTimeLabel: "පෙරවරු 11ට",
    countdownTarget: "September 13, 2026 11:00:00",
  },
  bride: {
    name: "උතුමි ඉරාශා",
    parentsLine1: "ඩී.එච්.ඩී.කොලින් හර්බට්",
    parentsLine2: "සහ එම මැතිණිය",
  },
  groom: {
    name: "පසිඳු මදුසංක",
    parentsLine1: "විමලසිරි වීරසිංහ",
    parentsLine2: "සහ එම මැතිණිය",
  },
  venue: {
    name: "මනමාලියගෙ නිවසේ",
    addressLine1: "නො:351/A1, පෙරේරා මාවත ,",
    addressLine2: "අලුබෝමුල්ල.",
    blurb:
      "අපගේ ආදරණීය විවාහ ගිවිසගැනීමේ උත්සවයට සහභාගී වන ලෙස ඔබට ආදරයෙන් ඇරයුම් කරමු.",
    directionsUrl:
      "https://www.google.com/maps/search/?api=1&query=Alubomulla",
    mapEmbedUrl:
      "https://maps.google.com/maps?q=Alubomulla&t=&z=14&ie=UTF8&iwloc=&output=embed",
  },
  rsvpByLabel: "සැප්තැම්බර් මුලදී",
  footer: {
    year: "2026",
    contactName: "පසිඳු",
    contactPhoneHref: "0771234567",
    contactPhoneLabel: "077 123 4567",
  },
} as const;
...
function FloatingPetals({ disabled = false }: { disabled?: boolean }) {
  ...
  useEffect(() => {
    ...
    const colors = ["#c93e37", "#ba322c", "#df847f", "#9b2823"]; // Bolder, darker reds for better visibility
    const petalCount = isMobile ? 12 : 22; // Slightly more petals
    const newPetals = Array.from({ length: petalCount }).map((_, i) => ({
      id: i,
      x: Math.random() * 100,
      size: Math.random() * 12 + 14, // Larger size: 14 to 26
...
function CountdownTimer() {
  const targetDate = new Date(INVITE.details.countdownTarget).getTime();
        ...
        {!isOpened ? (
          ...
          >
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-10">
              ...
              <p className="text-stone-500 text-sm tracking-[0.2em] font-light">{INVITE.hero.saveTheDateMonth}</p>
            </motion.div>
            ...
            >
              ...
              {/* Left Flap */}
              <motion.div
                className="absolute inset-y-0 left-0 w-1/2 bg-gradient-to-br from-[#9b2823] via-[#c93e37] to-[#812521] z-30 shadow-[8px_0_28px_rgba(29,13,27,0.45)] origin-left flex items-center justify-end pr-4 overflow-hidden rounded-l-[1.2rem]"
              ...
              >
                ...
                <InviteImage
                  src={mandalaImage}
                  className="absolute -top-20 md:-top-28 -left-20 md:-left-28 w-56 md:w-72 h-56 md:h-72 opacity-55 mix-blend-screen grayscale brightness-200"
                  alt=""
                />
                <InviteImage
                  src={mandalaImage}
                  className="absolute -bottom-20 md:-bottom-28 -left-20 md:-left-28 w-56 md:w-72 h-56 md:h-72 opacity-50 mix-blend-screen -rotate-90 grayscale brightness-200"
                  alt=""
                />

                <div className="text-theme-100/35 rotate-90 whitespace-nowrap text-xs tracking-[0.55em] uppercase font-bold relative z-10">
                  {INVITE.couple.displayUpper}
                </div>
              </motion.div>

              {/* Right Flap */}
              <motion.div
                className="absolute inset-y-0 right-0 w-1/2 bg-gradient-to-bl from-[#9b2823] via-[#c93e37] to-[#812521] z-30 shadow-[-8px_0_28px_rgba(29,13,27,0.45)] origin-right flex items-center justify-start pl-4 overflow-hidden rounded-r-[1.2rem]"
                whileHover={{ rotateY: 14 }}
                transition={{ type: "spring", stiffness: 110, damping: 16 }}
              >
                <div className="absolute inset-0 opacity-20 paper-grain" />
                ...
                <InviteImage
                  src={mandalaImage}
                  className="absolute -top-20 md:-top-28 -right-20 md:-right-28 w-56 md:w-72 h-56 md:h-72 opacity-55 mix-blend-screen rotate-90 grayscale brightness-200"
                  alt=""
                />
                <InviteImage
                  src={mandalaImage}
                  className="absolute -bottom-20 md:-bottom-28 -right-20 md:-right-28 w-56 md:w-72 h-56 md:h-72 opacity-50 mix-blend-screen rotate-180 grayscale brightness-200"
                  alt=""
                />
              </motion.div>
              ...
              <motion.div
                ...
                whileTap={{ scale: 0.9 }}
                className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-40 w-28 h-28 rounded-full bg-gradient-to-br from-theme-200 via-[#fff5fb] to-theme-300 shadow-[0_20px_45px_-10px_rgba(131,63,105,0.65)] border-[5px] border-white flex items-center justify-center group-hover:shadow-theme-500/40"
              >
                ...
                <div className="text-center relative z-10 flex items-center justify-center">
                  <Heart className="w-12 h-12 text-theme-900 fill-theme-800/90 drop-shadow-md" />
                </div>
              </motion.div>
          ...
          >
            ...
            <section className="min-h-[100dvh] w-full flex items-center justify-center p-4 md:p-12 relative overflow-hidden bg-[#fdfaf5]">
              ...
              >
                {/* Background Watermark inside the Arch */}
                <div className="absolute inset-0 pointer-events-none z-0">
                  <img src={brideGroomImage} alt="" className="w-full h-full object-cover opacity-[0.15] mix-blend-multiply" />
                  <div className="absolute inset-0 bg-gradient-to-t from-white via-white/80 to-white/20" />
                </div>

                {/* Arch outline decoration */}
                <div className="absolute inset-3 sm:inset-5 border-[0.5px] border-theme-400/40 rounded-t-full pointer-events-none z-20" />
                <div className="absolute inset-4 sm:inset-6 border border-theme-200/40 rounded-t-full pointer-events-none z-20" />

                <motion.div
                  initial={{ rotate: -45, opacity: 0 }}
                  animate={{ rotate: 0, opacity: 0.85 }}
                  transition={{ duration: 1.5, delay: 0.5, type: "spring" }}
                  className="w-24 h-24 md:w-32 md:h-32 mb-6 drop-shadow-md bg-theme-800"
                  style={{
                    WebkitMaskImage: `url(${mandalaImage})`,
                    WebkitMaskSize: "contain",
                    WebkitMaskRepeat: "no-repeat",
                    WebkitMaskPosition: "center",
                    maskImage: `url(${mandalaImage})`,
                    maskSize: "contain",
                ...
                <div className="flex flex-col items-center text-center space-y-4 flex-1 w-full relative z-10">
                  ...
                  >
                    ...
                    <div className="font-cinzel space-y-1">
                      <p className="text-sm md:text-base text-stone-700 tracking-[0.2em] md:tracking-[0.3em] font-bold">{INVITE.hero.dateLabel}</p>
                      <p className="text-[8px] md:text-[9px] text-theme-600 tracking-[0.2em] uppercase font-bold">{INVITE.hero.locationLabel}</p>
                    </div>
                  </motion.div>
                </div>
              </motion.div>
                ...
                <div className="relative w-full flex flex-col md:flex-row items-center justify-center md:items-stretch gap-6 md:gap-10 my-12 md:my-20 z-10 px-2 lg:px-8">
                  ...
                  >
                    ...
                    <div className="relative z-10 space-y-4 py-8 md:py-12">
                      ...
                      <h3 className="text-5xl md:text-7xl font-playball text-theme-800 group-hover:scale-110 transition-transform duration-700 pt-6 drop-shadow-sm">{INVITE.bride.name}</h3>
                    </div>
                  </motion.div>
                  ...
                  <div className="flex flex-row md:flex-col items-center justify-center gap-4 py-4 md:py-0 relative z-20">
                    ...
                    >
                      <Heart className="w-8 h-8 md:w-12 md:h-12 text-white fill-white md:-mt-1 drop-shadow-md" />
                    </motion.div>
                    <div className="hidden md:block w-px h-32 bg-gradient-to-b from-theme-300 to-transparent" />
                  </div>

                  {/* Groom's Card - Offset structurally on desktop */}
                  <motion.div
                    initial={{ opacity: 0, x: 30, y: 20 }}
                    whileInView={{ opacity: 1, x: 0, y: 0 }}
                    viewport={{ once: true }}
                  ...
                  >
                    ...
                    <div className="relative z-10 space-y-4 py-8 md:py-12">
                      <div className="space-y-2">
                        <p className="text-[7px] md:text-[8px] uppercase tracking-[0.4em] font-bold text-stone-400">ආදරණීය පුතුණුවන්</p>
                        <p className="text-xs md:text-sm font-cinzel text-stone-600 tracking-wide leading-relaxed">
                          {INVITE.groom.parentsLine1}
                          <br />{INVITE.groom.parentsLine2}
                        </p>
                      </div>
                      <h3 className="text-5xl md:text-7xl font-playball text-theme-800 group-hover:scale-110 transition-transform duration-700 pt-6 drop-shadow-sm">{INVITE.groom.name}</h3>
                    </div>
                  </motion.div>
                </div>

                {/* Date and Time Luxury Layout */}
                <motion.div
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                ...
                <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
                  ...
                  >
                    ...
                    <div className="space-y-6 pt-4 relative">
                      ...
                      <div className="pl-8 space-y-4">
                        ...
                        <p className="text-lg md:text-xl text-stone-700 font-cinzel font-medium leading-relaxed tracking-wide">
                          {INVITE.venue.addressLine1}<br /> {INVITE.venue.addressLine2}
                        </p>
                      </div>
                    ...
                    <div className="pt-8 w-full md:w-auto">
                      <button
                        onClick={() => window.open(INVITE.venue.directionsUrl, '_blank')}
            ...
            <section className="cv-auto py-24 md:py-36 bg-[#2c2a26] text-white relative overflow-hidden flex flex-col items-center">
              ...
              <div className="container mx-auto px-4 max-w-2xl text-center relative z-10 w-full">
                ...
                >
                  <p className="text-[10px] md:text-[12px] tracking-[0.4em] md:tracking-[0.6em] text-theme-300 font-bold mb-6">ඔබ අප සමඟ එක්වන්නේද?</p>
                  <h2 className="font-playball text-[3.5rem] sm:text-[4rem] md:text-[5.5rem] text-white mb-6 drop-shadow-md">පැමිණීම දන්වන්න</h2>
                  ...
                  <p className="text-stone-300 text-sm md:text-base max-w-md mx-auto leading-relaxed mb-16 tracking-wide font-light">
                    ඔබගේ පැමිණීම අපට මහත් සතුටකි. කරුණාකර {INVITE.rsvpByLabel} පෙර අප වෙත දන්වන්න.
                  </p>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="relative">
                          ...
                          >
                            ...
                            <option value="3" className="bg-[#2c2a26] text-white">තිදෙනෙකු</option>
                            <option value="4" className="bg-[#2c2a26] text-white">සිව් දෙනෙකු</option>
                ...
                <div className="container mx-auto px-4 max-w-4xl text-center relative z-10 w-full">
                  ...
                  >
                    ...
                    <p className="text-stone-500 text-sm md:text-lg leading-relaxed max-w-xl mx-auto mb-16 font-light tracking-wide px-4">
                      ඔබගේ පැමිණීම අපට ඉමහත් සතුටකි. ඔබට අප වෙත සුබපැතුම් එක් කිරීමට අවශ්‍ය නම්, එය අපට මහත් ආශිර්වාදයකි!
                    </p>
                    ...
                    <div className="mt-32 md:mt-48 space-y-6 flex flex-col items-center relative w-full">
                      ...
                      <h3 className="font-playball text-[3.2rem] sm:text-6xl md:text-8xl text-theme-900 relative z-10 drop-shadow-sm px-4 pt-2 leading-none">{INVITE.couple.display}</h3>
